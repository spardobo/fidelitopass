        ...
        @if ($canManagePasskeys)
            <section class="mt-12">
                ...
                <div class="mt-6 flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
                    <div class="border rounded-lg border-white/10 overflow-hidden">
                        @forelse ($passkeys as $passkey)
                            <div class="flex items-center justify-between p-4 {{ ! $loop->last ? 'border-b border-white/10' : '' }}">
                                <div class="flex items-center gap-4">
                                    <div class="flex size-10 shrink-0 items-center justify-center rounded-xl bg-white/5">
                                ...
                                <flux:button
                                    ...
                                    class="text-red-400 hover:bg-red-950/50 hover:text-red-300 focus-visible:text-red-300"
                                />
                            </div>
                        @empty
                            <div class="p-8 text-center">
                                <div class="mx-auto mb-4 flex size-14 items-center justify-center rounded-2xl bg-white/5">
